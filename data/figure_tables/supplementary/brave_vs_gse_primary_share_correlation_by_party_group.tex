...
\caption{Correlation between Primary source shares in Brave Search results and GSE citations, grouped by party group.}
\label{tab:brave-gse-primary-share-correlation-party-group}
\begin{tabular}{llccc}
\toprule
