...
\caption{Correlation between Primary source shares in Brave Search results and GSE citations, grouped by user profile.}
\label{tab:brave-gse-primary-share-correlation-user-profile}
\begin{tabular}{llccc}
\toprule
